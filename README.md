...
### Usage
For non Pull Request page the extension will be disabled ![Disabled][./icons/turbopr38_chrome_disabled.png].
On a PR compare page it will get enabled but by default turned off ![On][./icons/turbopr38_disabled.png].
If you feel your page is getting slow on a big PR you can click and turn it on ![On][./icons/turbopr38.png]. You can toggle it back to off if you want.
